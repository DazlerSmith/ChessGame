...
namespace ChessGame2._0
{
    ...
    ///Max was here.
        ...
        public class Game1 : Game
        {
            ...
            temp = new Piece(PieceTexture, 7, 4, 50, 200);
            ...
            temp = new Piece(PieceTexture, 7, 3, 50, 200);
            ...
            for (int i = 0; i < 8; i++)
            {
                temp = new Piece(PieceTexture, 1, i, 50, 200);
            ...
            temp = new Piece(PieceTexture, 0, 4, 50, 200);
            ...
            temp = new Piece(PieceTexture, 0, 3, 50, 200);
